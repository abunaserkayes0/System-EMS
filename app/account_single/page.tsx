    ...
    <section className="bg-[#ecf0f1]">
      <div className="flex flex-col container px-6 py-6">
        ...
        <div className="flex flex-row justify-around">
          ...
          <div className="w-7/12 px-4 mt-8 bg-white py-6">
            ...
            <div className="mt-4">
              ...
              <p className="text-base mt-6"> Contact Number: 00000</p>
              <p className="text-base mt-6">Amount: 2000Tk</p>

              <p className="text-base mt-6">Date: 12.10.2023</p>
              <p className="text-base mt-6">Payment Status: Paid </p>
            </div>
          </div>
        </div>
      </div>
